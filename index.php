    ...
    public function responseBlog()
    {
        ...
        if (!empty($postStr)){
                ...
                if(!empty( $keyword ))
                {
                    ...
                    $picUrl1 = "http://1.tianwenweixintest.sinaapp.com/image/1.jpg";
